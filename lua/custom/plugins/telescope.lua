return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>ft', builtin.colorscheme, { desc = '[S]earch [T]heme' })
    ...
    vim.keymap.set('n', '<leader>cf', function() builtin.find_files { cwd = vim.fn.stdpath 'config' } end, { desc = '[S]earch [N]eovim files' })
  end,
}
